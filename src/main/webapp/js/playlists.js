...
audio.addEventListener('ended',function(){
    if(currentPlaylist != -1) {
        if(playlistIndex < playlistTracks[currentPlaylist].length) {
            let info = `<source src=${playlistTracks[currentPlaylist][playlistIndex]} type="audio/mpeg">`
